...
(function () {
  ...
  var WORDS = {
    tr: {
      ...
      joinAbout:     "Bu kulüp, okumayı ve fikirlerini paylaşmayı seven kitap kurtları için. Her kitabı bitirdiğimde ne düşündüğümü sana yazacağım ve kitabı birlikte konuşacağız.",
    ...
    en: {
      ...
      joinAbout:     "This club is for book nerds who love to read, share ideas, and talk books together. Every time I finish a book, I'll send you what I thought about it, and we'll talk it over together.",
