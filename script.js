...
(function () {
  ...
  var WORDS = {
    tr: {
      ...
      joinAbout:     "Bu kulüp, okumayı ve fikirlerini paylaşmayı seven kitap kurtları için. Her kitabı bitirdiğimde ne düşündüğümü sana yazacağım — sen de cevap verirsin, kitabı birlikte konuşuruz.",
    ...
    en: {
      ...
      joinAbout:     "This club is for book nerds who love to read, share ideas, and talk books together. Every time I finish a book, I'll send you what I thought about it — and you can write back, so we discuss it together.",
